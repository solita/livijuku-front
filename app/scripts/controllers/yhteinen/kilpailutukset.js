...
angular.module('jukufrontApp').controller('KilpailutuksetCtrl', ['$scope', '$state', '$element', '$uibModal', 'OrganisaatioService', function ($scope, $state, $element, $uibModal, OrganisaatioService) {
  ...
  $scope.kilpailutukset = [{
    ...
    organisaatioId: 1,
    name: 'Kohde 1',
    dates: [new Date('2016-04-20'), new Date('2016-06-20'), new Date('2016-09-20'), new Date('2016-12-20')],
    linkToHilma: 'http://www.hankintailmoitukset.fi/fi/'
  }, {
    id: 'kohde-2',
    organisaatioId: 1,
    name: 'Kohde 2',
    dates: [new Date('2016-03-01'), new Date('2016-06-30'), new Date('2016-10-01'), new Date('2017-01-01')],
    linkToHilma: false
  }, {
    id: 'kohde-1',
    organisaatioId: 2,
    name: 'Kohde 1',
    dates: [new Date('2016-04-20'), new Date('2016-06-20'), new Date('2016-09-20'), new Date('2017-02-20')],
    linkToHilma: 'http://www.hankintailmoitukset.fi/fi/'
  }];
